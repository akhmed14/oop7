from hw.VendingMachine import VendingMachine
from hw.BottleOfWater import BottleOfWater
from hw.HotDrinks import HotDrinks
from hw.ConsoleUserInterface import ConsoleUserInterface
